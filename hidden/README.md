...
- [Try the demo](https://arvindh123.github.io/projects/hidden-bookmarks/#demo)
...
Almost a year ago, I created [Link Lock](https://arvindh123.github.io/link-lock)
...
- [A stable, simplified version integrated directly into Link
  Lock](https://arvindh123.github.io/link-lock/hidden/)
- [An experimental
  version](https://arvindh123.github.io/projects/hidden-bookmarks/#demo), designed
...
Lock](https://arvindh123.github.io/link-lock/).
...
GitHub](https://github.com/arvindh123/link-lock/issues/new) or use my [contact
form](https://arvindh123.github.io/about#contact).
...
- Despite spending hours revising the instructions for the [Link Lock hidden
  bookmarks](https://arvindh123.github.io/link-lock/hidden/) page, it is still far
